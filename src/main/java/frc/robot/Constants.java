...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMagnitudeSlewRate = 1.8; // percent per second (1 = 100%) //lower by .2
    public static final double kRotationalSlewRate = 2.0; // percent per second (1 = 100%) //lower by .2
