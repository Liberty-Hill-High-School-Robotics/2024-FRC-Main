...
SendableChooser<Command> m_chooser = new SendableChooser<>();
  ...
  public RobotContainer() {
    ...
    SmartDashboard.putData("AnglePivot", new AnglePivot(m_pivot, 40)); //m_pivot.calculateAngle()
    SmartDashboard.putData("RevShooter", new RevShooter(m_shooter, .6));//m_shooter.calculateSpeed()
